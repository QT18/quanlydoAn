...
<body>
    ...
    <div style=" align=center">
        <a href="">
        <img src="https://old.ctuet.edu.vn/CSS/MainPage/Image/banner.jpg" alt="ảnh CTUET" width="100%" height= "300px">        </a>
        </a>
    </div>
        <div id="menu">
            ...
            |
            <a href="views/dsdangky.php">Đã đăng ký</a>
            |
      ...
      $sql="SELECT * FROM tbl_sinhvien WHERE Email='$email'";
      ...
      if (mysqli_num_rows($kq) > 0) {
        {while ($row= mysqli_fetch_assoc($kq)) {
            ...
            Sinh viên: <a href="login.php">Đăng Xuất</a>
        </div>
        </div>
        <div >
        <span style="z-index: -1; align=center " id="news-block-title" >TIN TỨC SỰ KIỆN</span>

        <div style="align=center padding-top: 50px">
          <table style="position: relative; top: 20%;" width="1000%">
          <div class="body">
            <div class="item">
